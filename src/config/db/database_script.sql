...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 04, 2023 at 08:14 PM
...
(1, 'HTML CSS từ Zero đến Hero', 3, '1.png', 2, 0, NULL, 0, 'Trong khóa này chúng ta sẽ cùng nhau xây dựng giao diện 2 trang web là The Band & Shopee.', 'Html and css from zero to hero', '1.Html\n2.Css', '2023-01-04 17:12:17', '2023-01-04 17:12:17', 'html-css-từ-zero-đến-hero-1'),
(2, 'Lập Trình JavaScript Cơ Bản', 3, '2.png', 2, 0, NULL, 0, 'Học Javascript cơ bản phù hợp cho người chưa từng học lập trình. Với hơn 100 bài học và có bài tập t', 'Javascript cơ bản cho người mới bắt đầu', '1.Javascript', '2022-08-03 00:00:00', '2023-01-04 17:12:17', 'lập-trình-javascript-cơ-bản-1'),
(3, 'Learn Python: The Complete Python Programming Course', 4, '3.png', 3, 999000, NULL, 0, 'Learn A-Z everything about Python, from the basics, to advanced topics like Python GUI, Python Data ', 'Create their own Python Programs\nBecome an experienced Python Programmer\nParse the Web and Create their own Games', '', '2022-11-25 00:00:00', '2023-01-04 17:12:17', 'learn-python-the-complete-python-programming-course-1'),
...
(1, 'admin1', 'admin1@gmail.com', '$2a$10$FV2dj5JYTGT08V/97UE8eehPU/j05EMGtvMutUj6EOS', 'ADMIN'),
(2, 'student1', 'student1@gmail.com', '$2a$10$GflWaMQ7N9M7srFllbJMvuCPFEEIHVCOoN7TWirN9YM', 'STUDENT'),
(3, 'lecturer1', 'lecturer1@gmail.com', '$2a$10$Nd1fSbD4z59H8j4YP3Y6WOe.FVp/ncq7.V..px.K53Y', 'LECTURER'),
(4, 'Avinash_Jain', 'avinashjain@gmail.com', '$2a$10$/ttfYvdnmR9ooVebDjArauqoftEgd3roisp3G464.DV', 'LECTURER'),
(5, 'Mark_Lassoff', 'marklassoff@gmail.com', '$2a$10$aelFfre4osCBkjG0DwnObOABSOsE6WXYFdOn3ZN6gds', 'LECTURER'),
(6, 'Stone_River_eLearning', 'stoneriverelearning@gmail.com', '$2a$10$RAfIuKUvntvprxN0FXnIg.D.IIjltb.F2q1QgLce4hD', 'LECTURER'),
(7, 'student2', 'student2@gmail.com', '$2a$10$bkcbwGXh5wWt6P2APPJlC.DCDKekvwzLnRjg02pbHHP', 'STUDENT'),
(8, 'John_Purcell', 'johnpurcell@gmail.com', '$2a$10$ziiw276RUdy0gY82BdSG4e5FpTmgGJeR88A/ENxhIS0', 'LECTURER');
