const uploadImageOverlay = document.querySelector(
  '.course-image-wrapper-overlay'
);
const uploadCourseBannerInput = document.querySelector(
  '#uploadCourseBannerInput'
);
...
mainForm.addEventListener('submit', async (event) => {
  ...
  const imageBannerInputError = document.querySelector(
    '#imageBannerInputError'
  );
  const courseCategoryInputError = document.querySelector(
    '#courseCategoryInputError'
  );
  const courseShortDescriptionError = document.querySelector(
    '#courseShortDescriptionError'
  );
  const courseDetailDescriptionError = document.querySelector(
    '#courseDetailDescriptionError'
  );
  const syllabusDescriptionError = document.querySelector(
    '#syllabusDescriptionError'
  );
